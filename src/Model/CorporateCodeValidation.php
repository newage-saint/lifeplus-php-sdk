...
/**
 * CorporateCodeValidation Class Doc Comment
 *
 * @category Class
 * @description Corporate code validation (request payload - noun-based DTO per IDEAL_MODELS.md)
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CorporateCodeValidation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CorporateCodeValidation';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Corporate discount code to validate
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param int|null $user_id Optional user ID for validation context
     *
     * @return self
     */
