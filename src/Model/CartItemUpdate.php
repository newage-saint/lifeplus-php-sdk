...
/**
 * CartItemUpdate Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class CartItemUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartItemUpdate';
    ...
    */
     ...
     * Sets action
     *
     * @param string|null $action Action to perform on quantity
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity Required when action is 'set'
     *
     * @return self
     */
