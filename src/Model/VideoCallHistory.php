...
/**
 * VideoCallHistory Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class VideoCallHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VideoCallHistory';
    ...
    public const CALL_TYPE_VIDEO = 'video';
    public const CALL_TYPE_AUDIO = 'audio';
     ...
     * @return string[]
     */
    public function getCallTypeAllowableValues()
    {
        return [
            self::CALL_TYPE_VIDEO,
            self::CALL_TYPE_AUDIO,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCallTypeAllowableValues();
        if (!is_null($this->container['call_type']) && !in_array($this->container['call_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'call_type', must be one of '%s'",
                $this->container['call_type'],
    ...
    public function setCallType($call_type)
    {
        ...
        $allowedValues = $this->getCallTypeAllowableValues();
        if (!in_array($call_type, $allowedValues, true)) {
