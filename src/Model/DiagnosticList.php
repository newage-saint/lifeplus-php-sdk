...
/**
 * DiagnosticList Class Doc Comment
 *
 * @category Class
 * @description List response for /diagnostics
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DiagnosticList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DiagnosticList';
    ...
    protected static $openAPITypes = [
        'data' => '\LifePlus\SDK\Model\Diagnostic[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \LifePlus\SDK\Model\Diagnostic[]|null
     */
     ...
     * Sets data
     *
     * @param \LifePlus\SDK\Model\Diagnostic[]|null $data data
     *
     * @return self
     */
