...
/**
 * PartnerDiagnosticDetails Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerDiagnosticDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerDiagnosticDetails';
    ...
    protected static $openAPITypes = [
        'diagnostic_items' => '\LifePlus\SDK\Model\PartnerDiagnosticItem[]',
        'hospital_id' => 'int',
        'preferred_date' => '\DateTime',
        'preferred_time' => 'string',
        'home_sample_collection' => 'bool',
        'notes' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'diagnostic_items' => null,
        'hospital_id' => null,
        'preferred_date' => 'date',
        'preferred_time' => null,
        'home_sample_collection' => null,
        'notes' => null
    ];
    ...
    protected static $getters = [
        'diagnostic_items' => 'getDiagnosticItems',
        'hospital_id' => 'getHospitalId',
        'preferred_date' => 'getPreferredDate',
        'preferred_time' => 'getPreferredTime',
        'home_sample_collection' => 'getHomeSampleCollection',
        'notes' => 'getNotes'
    ];
    ...
    {
        $this->setIfExists('diagnostic_items', $data ?? [], null);
        $this->setIfExists('hospital_id', $data ?? [], null);
        $this->setIfExists('preferred_date', $data ?? [], null);
        $this->setIfExists('preferred_time', $data ?? [], null);
        $this->setIfExists('home_sample_collection', $data ?? [], false);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['diagnostic_items'] === null) {
            $invalidProperties[] = "'diagnostic_items' can't be null";
        }
    ...
    /**
     * Gets diagnostic_items
     *
     * @return \LifePlus\SDK\Model\PartnerDiagnosticItem[]
     */
    public function getDiagnosticItems()
    {
        return $this->container['diagnostic_items'];
    }

    /**
     * Sets diagnostic_items
     *
     * @param \LifePlus\SDK\Model\PartnerDiagnosticItem[] $diagnostic_items diagnostic_items
     *
     * @return self
     */
    public function setDiagnosticItems($diagnostic_items)
    {
        if (is_null($diagnostic_items)) {
            throw new \InvalidArgumentException('non-nullable diagnostic_items cannot be null');
        }
        $this->container['diagnostic_items'] = $diagnostic_items;
    ...
    public function setHospitalId($hospital_id)
    {
        if (is_null($hospital_id)) {
            array_push($this->openAPINullablesSetToNull, 'hospital_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hospital_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets preferred_date
     *
     * @param \DateTime|null $preferred_date preferred_date
     *
     * @return self
     */
    ...
    {
        return $this->container['preferred_time'];
    }

    /**
     * Sets preferred_time
     *
     * @param string|null $preferred_time preferred_time
     *
     * @return self
     */
    public function setPreferredTime($preferred_time)
    {
        if (is_null($preferred_time)) {
            throw new \InvalidArgumentException('non-nullable preferred_time cannot be null');
        }
        $this->container['preferred_time'] = $preferred_time;

        return $this;
    }

    /**
     * Gets home_sample_collection
     *
     * @return bool|null
     */
    public function getHomeSampleCollection()
    {
        return $this->container['home_sample_collection'];
    }

    /**
     * Sets home_sample_collection
     *
     * @param bool|null $home_sample_collection home_sample_collection
     *
     * @return self
     */
    public function setHomeSampleCollection($home_sample_collection)
    {
        if (is_null($home_sample_collection)) {
            throw new \InvalidArgumentException('non-nullable home_sample_collection cannot be null');
        }
        $this->container['home_sample_collection'] = $home_sample_collection;
