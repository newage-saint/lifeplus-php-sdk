...
/**
 * PartnerDiagnosticItem Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerDiagnosticItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerDiagnosticItem';
    ...
    protected static $setters = [
        'diagnostic_id' => 'setDiagnosticId',
        'diagnostic_name' => 'setDiagnosticName',
        'price' => 'setPrice'
    ];
    ...
    protected static $getters = [
        ...
        'diagnostic_name' => 'getDiagnosticName',
        'price' => 'getPrice'
    ];
    ...
    {
        $this->setIfExists('diagnostic_id', $data ?? [], null);
        $this->setIfExists('diagnostic_name', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['diagnostic_id'] === null) {
            $invalidProperties[] = "'diagnostic_id' can't be null";
        }
    ...
    {
        return $this->container['diagnostic_id'];
    }

    /**
     * Sets diagnostic_id
     *
     * @param int $diagnostic_id diagnostic_id
     *
     * @return self
     */
    public function setDiagnosticId($diagnostic_id)
    {
        if (is_null($diagnostic_id)) {
            throw new \InvalidArgumentException('non-nullable diagnostic_id cannot be null');
        }
        $this->container['diagnostic_id'] = $diagnostic_id;

        return $this;
    }

    /**
     * Gets diagnostic_name
     *
     * @return string|null
     */
    public function getDiagnosticName()
    {
        return $this->container['diagnostic_name'];
    }

    /**
     * Sets diagnostic_name
     *
     * @param string|null $diagnostic_name Optional, for reference
     *
     * @return self
     */
    public function setDiagnosticName($diagnostic_name)
    {
        if (is_null($diagnostic_name)) {
            throw new \InvalidArgumentException('non-nullable diagnostic_name cannot be null');
        }
        $this->container['diagnostic_name'] = $diagnostic_name;
