...
/**
 * PartnerApiKey Class Doc Comment
 *
 * @category Class
 * @description Partner API Key entity (flattened for clean SDK generation)
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PartnerApiKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerApiKey';
