...
/**
 * PackageServiceUsage Class Doc Comment
 *
 * @category Class
 * @description Record usage of a package service
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PackageServiceUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageServiceUsage';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('usage_date', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['usage_date'] === null) {
            $invalidProperties[] = "'usage_date' can't be null";
        }
     ...
     * Sets service_type
     *
     * @param string $service_type Type of service used from the package
     *
     * @return self
     */
     ...
     * Sets usage_date
     *
     * @param \DateTime $usage_date usage_date
     *
     * @return self
     */
    public function setUsageDate($usage_date)
    {
        if (is_null($usage_date)) {
            throw new \InvalidArgumentException('non-nullable usage_date cannot be null');
        }
     ...
     * Sets provider_id
     *
     * @param int|null $provider_id ID of the service provider
     *
     * @return self
     */
     ...
     * Sets cost
     *
     * @param float|null $cost Cost of the service
     *
     * @return self
     */
