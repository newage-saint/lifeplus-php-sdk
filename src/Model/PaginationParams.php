...
/**
 * PaginationParams Class Doc Comment
 *
 * @category Class
 ...
 */
class PaginationParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginationParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('per_page', $data ?? [], 10);
        $this->setIfExists('sort', $data ?? [], null);
        $this->setIfExists('order', $data ?? [], 'desc');
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling PaginationParams., must be bigger than or equal to 1.');
        }
    ...
    public function setPerPage($per_page)
    {
        ...
        if (($per_page > 100)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling PaginationParams., must be smaller than or equal to 100.');
        }
        if (($per_page < 1)) {
            throw new \InvalidArgumentException('invalid value for $per_page when calling PaginationParams., must be bigger than or equal to 1.');
        }
