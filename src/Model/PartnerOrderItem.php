...
/**
 * PartnerOrderItem Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerOrderItem';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling PartnerOrderItem., must be bigger than or equal to 1.');
        }
     ...
     * Sets price
     *
     * @param float|null $price Unit price (optional, will be validated against catalog)
     *
     * @return self
     */
