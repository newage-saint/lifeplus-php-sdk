...
/**
 * PackageCorporateEnrollment Class Doc Comment
 *
 * @category Class
 * @description Request body for enrolling a user in a corporate package order
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PackageCorporateEnrollment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PackageCorporateEnrollment';
    ...
    */
     ...
     * Sets corporate_code
     *
     * @param string|null $corporate_code corporate_code
     *
     * @return self
     */
    public function setCorporateCode($corporate_code)
    {
        if (is_null($corporate_code)) {
            throw new \InvalidArgumentException('non-nullable corporate_code cannot be null');
        }
