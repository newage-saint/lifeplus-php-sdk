...
class Appointment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('patient_id', $data ?? [], null);
    ...
    */
     ...
     * Sets patient_id
     *
     * @param int|null $patient_id patient_id
     *
     * @return self
     */
    public function setPatientId($patient_id)
    {
        if (is_null($patient_id)) {
            throw new \InvalidArgumentException('non-nullable patient_id cannot be null');
        }
     ...
     * Sets doctor_id
     *
     * @param int|null $doctor_id doctor_id
     *
     * @return self
     */
