...
class PartnerLogin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'token_type' => 'string',
        'expires_in' => 'int',
        'partner' => '\LifePlus\SDK\Model\PartnerBasic'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^lpk_(live|test)_[a-zA-Z0-9]{40}$/", $this->container['api_key'])) {
            $invalidProperties[] = "invalid value for 'api_key', must be conform to the pattern /^lpk_(live|test)_[a-zA-Z0-9]{40}$/.";
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((!preg_match("/^lpk_(live|test)_[a-zA-Z0-9]{40}$/", ObjectSerializer::toString($api_key)))) {
            throw new \InvalidArgumentException("invalid value for \$api_key when calling PartnerLogin., must conform to the pattern /^lpk_(live|test)_[a-zA-Z0-9]{40}$/.");
        }
     ...
     * Gets partner
     *
     * @return \LifePlus\SDK\Model\PartnerBasic|null
     */
     ...
     * Sets partner
     *
     * @param \LifePlus\SDK\Model\PartnerBasic|null $partner partner
     *
     * @return self
     */
