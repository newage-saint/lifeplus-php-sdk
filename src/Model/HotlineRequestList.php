...
/**
 * HotlineRequestList Class Doc Comment
 *
 * @category Class
 * @description Hotline request list response with pagination
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class HotlineRequestList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HotlineRequestList';
    ...
    protected static $openAPITypes = [
        'data' => '\LifePlus\SDK\Model\HotlineRequest[]',
        'meta' => '\LifePlus\SDK\Model\PaginationMeta'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \LifePlus\SDK\Model\HotlineRequest[]|null
     */
     ...
     * Sets data
     *
     * @param \LifePlus\SDK\Model\HotlineRequest[]|null $data data
     *
     * @return self
     */
     ...
     * Sets meta
     *
     * @param \LifePlus\SDK\Model\PaginationMeta|null $meta meta
     *
     * @return self
     */
