...
/**
 * AnalyticsDailyData Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsDailyData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnalyticsDailyData';
    ...
    */
     ...
     * Sets registrations
     *
     * @param int|null $registrations registrations
     *
     * @return self
     */
     ...
     * Sets transactions
     *
     * @param int|null $transactions transactions
     *
     * @return self
     */
