<?php
/**
 * PartnerApiKeyCreateDataAttributes
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PartnerApiKeyCreateDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerApiKeyCreateDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerApiKeyCreateDataAttributes';
    ...
    */
     ...
     * Sets partner_id
     *
     * @param int|null $partner_id ID of the partner who owns this key
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Descriptive name for this API key
     *
     * @return self
     */
     ...
     * Sets key_prefix
     *
     * @param string|null $key_prefix First 16 characters of the API key (for identification)
     *
     * @return self
     */
     ...
     * Sets environment
     *
     * @param string|null $environment Environment this key is for
     *
     * @return self
     */
     ...
     * Sets ip_whitelist
     *
     * @param string[]|null $ip_whitelist List of allowed IP addresses (empty means all IPs allowed)
     *
     * @return self
     */
     ...
     * Sets last_used_at
     *
     * @param \DateTime|null $last_used_at Last time this API key was used
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Expiration date for this key
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Whether this key is currently active
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at When this key was created
     *
     * @return self
     */
     ...
     * Sets api_key
     *
     * @param string|null $api_key The full API key (shown only once during creation)
     *
     * @return self
     */
