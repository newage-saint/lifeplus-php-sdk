...
/**
 * AppointmentList Class Doc Comment
 *
 * @category Class
 * @description Appointment list response with pagination
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AppointmentList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppointmentList';
    ...
    protected static $openAPITypes = [
        'data' => '\LifePlus\SDK\Model\Appointment[]',
    ...
    */
     ...
     * Gets data
     *
     * @return \LifePlus\SDK\Model\Appointment[]|null
     */
     ...
     * Sets data
     *
     * @param \LifePlus\SDK\Model\Appointment[]|null $data data
     *
     * @return self
     */
