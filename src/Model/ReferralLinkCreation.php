...
/**
 * ReferralLinkCreation Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class ReferralLinkCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReferralLinkCreation';
    ...
    protected static $openAPITypes = [
        'campaign' => 'string',
        'service_type' => 'string',
        'custom_params' => 'array<string,mixed>'
    ];
    ...
    public const SERVICE_TYPE_APPOINTMENT = 'appointment';
    public const SERVICE_TYPE_DIAGNOSTIC = 'diagnostic';
    public const SERVICE_TYPE_MEDICINE = 'medicine';
    public const SERVICE_TYPE_PACKAGE = 'package';
    ...
    {
        return [
            self::SERVICE_TYPE_APPOINTMENT,
            self::SERVICE_TYPE_DIAGNOSTIC,
            self::SERVICE_TYPE_MEDICINE,
            self::SERVICE_TYPE_PACKAGE,
    ...
    */
     ...
     * Sets campaign
     *
     * @param string|null $campaign Campaign identifier for tracking
     *
     * @return self
     */
     ...
     * Sets service_type
     *
     * @param string|null $service_type Specific service type or 'all' for general link
     *
     * @return self
     */
     ...
     * Sets custom_params
     *
     * @param array<string,mixed>|null $custom_params Custom UTM parameters for detailed tracking
     *
     * @return self
     */
