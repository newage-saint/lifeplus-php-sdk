...
/**
 * DoctorSlotQuery Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class DoctorSlotQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DoctorSlotQuery';
    ...
    protected static $openAPITypes = [
        'available_slot' => 'int',
        'doctor_id' => 'int',
        'telemedicine_date' => '\DateTime',
        'telemedicine_day' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'available_slot' => null,
        'doctor_id' => null,
        'telemedicine_date' => 'date',
        'telemedicine_day' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'doctor_id' => false,
        'telemedicine_date' => false,
        'telemedicine_day' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'doctor_id' => 'doctor_id',
        'telemedicine_date' => 'telemedicine_date',
        'telemedicine_day' => 'telemedicine_day'
    ];
    ...
    protected static $setters = [
        'available_slot' => 'setAvailableSlot',
        'doctor_id' => 'setDoctorId',
        'telemedicine_date' => 'setTelemedicineDate',
        'telemedicine_day' => 'setTelemedicineDay'
    ];
    ...
    protected static $getters = [
        'available_slot' => 'getAvailableSlot',
        'doctor_id' => 'getDoctorId',
        'telemedicine_date' => 'getTelemedicineDate',
        'telemedicine_day' => 'getTelemedicineDay'
    ];
    ...
    {
        $this->setIfExists('available_slot', $data ?? [], 1);
        $this->setIfExists('doctor_id', $data ?? [], null);
        $this->setIfExists('telemedicine_date', $data ?? [], null);
        $this->setIfExists('telemedicine_day', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['telemedicine_date'] === null) {
            $invalidProperties[] = "'telemedicine_date' can't be null";
        }
    ...
    {
        return $this->container['available_slot'];
    }

    /**
     * Sets available_slot
     *
     * @param int|null $available_slot available_slot
     *
     * @return self
     */
    public function setAvailableSlot($available_slot)
    {
        if (is_null($available_slot)) {
            throw new \InvalidArgumentException('non-nullable available_slot cannot be null');
        }
        $this->container['available_slot'] = $available_slot;
    ...
    /**
     * Gets telemedicine_date
     *
     * @return \DateTime
     */
    public function getTelemedicineDate()
    {
        return $this->container['telemedicine_date'];
    }

    /**
     * Sets telemedicine_date
     *
     * @param \DateTime $telemedicine_date telemedicine_date
     *
     * @return self
     */
    public function setTelemedicineDate($telemedicine_date)
    {
        if (is_null($telemedicine_date)) {
            throw new \InvalidArgumentException('non-nullable telemedicine_date cannot be null');
        }
        $this->container['telemedicine_date'] = $telemedicine_date;

        return $this;
    }

    /**
     * Gets telemedicine_day
     *
     * @return string|null
     */
    public function getTelemedicineDay()
    {
        return $this->container['telemedicine_day'];
    }

    /**
     * Sets telemedicine_day
     *
     * @param string|null $telemedicine_day telemedicine_day
     *
     * @return self
     */
    public function setTelemedicineDay($telemedicine_day)
    {
        if (is_null($telemedicine_day)) {
            throw new \InvalidArgumentException('non-nullable telemedicine_day cannot be null');
        }
        $this->container['telemedicine_day'] = $telemedicine_day;
