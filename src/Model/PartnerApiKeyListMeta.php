...
/**
 * PartnerApiKeyListMeta Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerApiKeyListMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerApiKeyListMeta';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Total number of API keys
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param int|null $active Number of active keys
     *
     * @return self
     */
