...
/**
 * UserPackageStatusRemainingServices Class Doc Comment
 *
 * @category Class
 * @description Remaining service counts for package
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UserPackageStatusRemainingServices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserPackageStatusRemainingServices';
    ...
    protected static $setters = [
        ...
        'diagnostic_tests' => 'setDiagnosticTests',
    ...
    protected static $getters = [
        ...
        'diagnostic_tests' => 'getDiagnosticTests',
    ...
    {
        $this->setIfExists('consultations', $data ?? [], null);
        $this->setIfExists('diagnostic_tests', $data ?? [], null);
        $this->setIfExists('medicines', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['consultations'];
    }

    /**
     * Sets consultations
     *
     * @param int|null $consultations consultations
     *
     * @return self
     */
    public function setConsultations($consultations)
    {
        if (is_null($consultations)) {
            throw new \InvalidArgumentException('non-nullable consultations cannot be null');
        }
        $this->container['consultations'] = $consultations;

        return $this;
    }

    /**
     * Gets diagnostic_tests
     *
     * @return int|null
     */
    public function getDiagnosticTests()
    {
        return $this->container['diagnostic_tests'];
    }

    /**
     * Sets diagnostic_tests
     *
     * @param int|null $diagnostic_tests diagnostic_tests
     *
     * @return self
     */
    public function setDiagnosticTests($diagnostic_tests)
    {
        if (is_null($diagnostic_tests)) {
            throw new \InvalidArgumentException('non-nullable diagnostic_tests cannot be null');
        }
        $this->container['diagnostic_tests'] = $diagnostic_tests;
    ...
    {
        return $this->container['medicines'];
    }

    /**
     * Sets medicines
     *
     * @param int|null $medicines medicines
     *
     * @return self
     */
    public function setMedicines($medicines)
    {
        if (is_null($medicines)) {
            throw new \InvalidArgumentException('non-nullable medicines cannot be null');
        }
        $this->container['medicines'] = $medicines;
