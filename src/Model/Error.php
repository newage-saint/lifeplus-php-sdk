...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'int',
        'message' => 'string',
        'details' => '\LifePlus\SDK\Model\ErrorDetail[]'
    ];
    ...
    {
        $this->setIfExists('success', $data ?? [], false);
    ...
    */
     ...
     * Sets code
     *
     * @param int $code HTTP status code or application error code
     *
     * @return self
     */
     ...
     * Gets details
     *
     * @return \LifePlus\SDK\Model\ErrorDetail[]|null
     */
     ...
     * Sets details
     *
     * @param \LifePlus\SDK\Model\ErrorDetail[]|null $details details
     *
     * @return self
     */
