...
/**
 * OrderCreation Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class OrderCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCreation';
    ...
    public const ORDER_TYPE_AMBULANCE = 'ambulance';
    public const ORDER_TYPE_PACKAGE = 'package';
    public const ORDER_TYPE_HOME_SAMPLE = 'home_sample';
    public const ORDER_TYPE_WELLBEING = 'wellbeing';
    public const ORDER_TYPE_HOME_CARE = 'home_care';
    ...
    {
        return [
            self::ORDER_TYPE_PRODUCT,
            self::ORDER_TYPE_APPOINTMENT,
            self::ORDER_TYPE_AMBULANCE,
            self::ORDER_TYPE_PACKAGE,
            self::ORDER_TYPE_HOME_SAMPLE,
            self::ORDER_TYPE_WELLBEING,
            self::ORDER_TYPE_HOME_CARE,
        ];
    }
    ...
    */
     ...
     * Sets order_type
     *
     * @param string $order_type Type of order being created
     *
     * @return self
     */
     ...
     * Sets cart_id
     *
     * @param int $cart_id Cart ID (for product orders)
     *
     * @return self
     */
