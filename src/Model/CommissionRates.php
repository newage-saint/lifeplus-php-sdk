...
/**
 * CommissionRates Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class CommissionRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommissionRates';
    ...
    */
     ...
     * Sets registration
     *
     * @param float|null $registration registration
     *
     * @return self
     */
     ...
     * Sets policy
     *
     * @param float|null $policy policy
     *
     * @return self
     */
