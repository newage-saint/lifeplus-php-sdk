...
/**
 * PartnerOrderUserInfo Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerOrderUserInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerOrderUserInfo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^01[0-9]{9}$/", $this->container['mobile'])) {
            $invalidProperties[] = "invalid value for 'mobile', must be conform to the pattern /^01[0-9]{9}$/.";
        }
    ...
    public function setMobile($mobile)
    {
        ...
        if ((!preg_match("/^01[0-9]{9}$/", ObjectSerializer::toString($mobile)))) {
            throw new \InvalidArgumentException("invalid value for \$mobile when calling PartnerOrderUserInfo., must conform to the pattern /^01[0-9]{9}$/.");
        }
