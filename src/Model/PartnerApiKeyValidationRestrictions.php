<?php
/**
 * PartnerApiKeyValidationRestrictions
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PartnerApiKeyValidationRestrictions Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerApiKeyValidationRestrictions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerApiKeyValidationRestrictions';
    ...
    */
     ...
     * Sets ip_whitelist
     *
     * @param string[]|null $ip_whitelist Allowed IP addresses
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime|null $expires_at Key expiration time
     *
     * @return self
     */
