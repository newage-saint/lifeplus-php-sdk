...
/**
 * CartItemAddition Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class CartItemAddition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartItemAddition';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CartItemAddition., must be bigger than or equal to 1.');
        }
