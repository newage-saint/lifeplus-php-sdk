...
/**
 * PartnerAppointmentDetails Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
 ...
 */
class PartnerAppointmentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartnerAppointmentDetails';
    ...
    protected static $setters = [
        ...
        'patient_problem' => 'setPatientProblem',
        'is_telemedicine' => 'setIsTelemedicine'
    ];
    ...
    protected static $getters = [
        ...
        'patient_problem' => 'getPatientProblem',
        'is_telemedicine' => 'getIsTelemedicine'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('patient_problem', $data ?? [], null);
        $this->setIfExists('is_telemedicine', $data ?? [], false);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/", $this->container['appointment_time'])) {
            $invalidProperties[] = "invalid value for 'appointment_time', must be conform to the pattern /^([0-1][0-9]|2[0-3]):[0-5][0-9]$/.";
        }
     ...
     * Sets specialty
     *
     * @param string|null $specialty specialty
     *
     * @return self
     */
    public function setSpecialty($specialty)
    {
        if (is_null($specialty)) {
            throw new \InvalidArgumentException('non-nullable specialty cannot be null');
        }
    ...
    public function setAppointmentTime($appointment_time)
    {
        ...
        if ((!preg_match("/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/", ObjectSerializer::toString($appointment_time)))) {
            throw new \InvalidArgumentException("invalid value for \$appointment_time when calling PartnerAppointmentDetails., must conform to the pattern /^([0-1][0-9]|2[0-3]):[0-5][0-9]$/.");
        }
    ...
    /**
     * Gets patient_problem
     *
     * @return string|null
     */
    public function getPatientProblem()
    {
        return $this->container['patient_problem'];
    }

    /**
     * Sets patient_problem
     *
     * @param string|null $patient_problem patient_problem
     *
     * @return self
     */
    public function setPatientProblem($patient_problem)
    {
        if (is_null($patient_problem)) {
            throw new \InvalidArgumentException('non-nullable patient_problem cannot be null');
        }
        $this->container['patient_problem'] = $patient_problem;

        return $this;
    }

    /**
     * Gets is_telemedicine
     *
     * @return bool|null
     */
    public function getIsTelemedicine()
    {
        return $this->container['is_telemedicine'];
    }

    /**
     * Sets is_telemedicine
     *
     * @param bool|null $is_telemedicine is_telemedicine
     *
     * @return self
     */
    public function setIsTelemedicine($is_telemedicine)
    {
        if (is_null($is_telemedicine)) {
            throw new \InvalidArgumentException('non-nullable is_telemedicine cannot be null');
        }
        $this->container['is_telemedicine'] = $is_telemedicine;
