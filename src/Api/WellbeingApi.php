...
/**
 * WellbeingApi Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
...
class WellbeingApi
{
    ...
    /**
     * Operation createWellbeingOrder
     *
     * Create wellbeing order
     *
     * @param  \LifePlus\SDK\Model\WellbeingOrder $wellbeing_order wellbeing_order (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWellbeingOrder'] to see the possible values for this operation
     *
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LifePlus\SDK\Model\WellbeingOrder|\LifePlus\SDK\Model\Error|\LifePlus\SDK\Model\Error|\LifePlus\SDK\Model\Error
     */
    public function createWellbeingOrder($wellbeing_order, string $contentType = self::contentTypes['createWellbeingOrder'][0])
    {
        list($response) = $this->createWellbeingOrderWithHttpInfo($wellbeing_order, $contentType);
        return $response;
    }

    /**
     * Operation createWellbeingOrderWithHttpInfo
     *
     * Create wellbeing order
     *
     * @param  \LifePlus\SDK\Model\WellbeingOrder $wellbeing_order (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWellbeingOrder'] to see the possible values for this operation
     *
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LifePlus\SDK\Model\WellbeingOrder|\LifePlus\SDK\Model\Error|\LifePlus\SDK\Model\Error|\LifePlus\SDK\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWellbeingOrderWithHttpInfo($wellbeing_order, string $contentType = self::contentTypes['createWellbeingOrder'][0])
    {
        $request = $this->createWellbeingOrderRequest($wellbeing_order, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\LifePlus\SDK\Model\WellbeingOrder' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LifePlus\SDK\Model\WellbeingOrder' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LifePlus\SDK\Model\WellbeingOrder', []),
            ...
            $returnType = '\LifePlus\SDK\Model\WellbeingOrder';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\LifePlus\SDK\Model\WellbeingOrder',
    ...
    /**
     * Operation createWellbeingOrderAsync
     *
     * Create wellbeing order
     *
     * @param  \LifePlus\SDK\Model\WellbeingOrder $wellbeing_order (required)
     ...
     */
    public function createWellbeingOrderAsync($wellbeing_order, string $contentType = self::contentTypes['createWellbeingOrder'][0])
    {
        return $this->createWellbeingOrderAsyncWithHttpInfo($wellbeing_order, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createWellbeingOrderAsyncWithHttpInfo
     *
     * Create wellbeing order
     *
     * @param  \LifePlus\SDK\Model\WellbeingOrder $wellbeing_order (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWellbeingOrderAsyncWithHttpInfo($wellbeing_order, string $contentType = self::contentTypes['createWellbeingOrder'][0])
    {
        $returnType = '\LifePlus\SDK\Model\WellbeingOrder';
        $request = $this->createWellbeingOrderRequest($wellbeing_order, $contentType);
    ...
    /**
     * Create request for operation 'createWellbeingOrder'
     *
     * @param  \LifePlus\SDK\Model\WellbeingOrder $wellbeing_order (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWellbeingOrder'] to see the possible values for this operation
     *
     ...
     */
    public function createWellbeingOrderRequest($wellbeing_order, string $contentType = self::contentTypes['createWellbeingOrder'][0])
    {

        // verify the required parameter 'wellbeing_order' is set
        if ($wellbeing_order === null || (is_array($wellbeing_order) && count($wellbeing_order) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $wellbeing_order when calling createWellbeingOrder'
            );
        }


        $resourcePath = '/wellbeing/orders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($wellbeing_order)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($wellbeing_order));
            } else {
                $httpBody = $wellbeing_order;
            }
    ...
    /**
     * Operation getWellbeingOrders
     *
     * Get wellbeing order history
     *
     * @param  int $user_id user_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWellbeingOrders'] to see the possible values for this operation
     *
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LifePlus\SDK\Model\WellbeingOrder[]|\LifePlus\SDK\Model\Error
     */
    public function getWellbeingOrders($user_id = null, string $contentType = self::contentTypes['getWellbeingOrders'][0])
    {
        list($response) = $this->getWellbeingOrdersWithHttpInfo($user_id, $contentType);
        return $response;
    }

    /**
     * Operation getWellbeingOrdersWithHttpInfo
     *
     * Get wellbeing order history
     *
     ...
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LifePlus\SDK\Model\WellbeingOrder[]|\LifePlus\SDK\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWellbeingOrdersWithHttpInfo($user_id = null, string $contentType = self::contentTypes['getWellbeingOrders'][0])
    {
        $request = $this->getWellbeingOrdersRequest($user_id, $contentType);
    ...
    /**
     * Operation getWellbeingOrdersAsync
     *
     * Get wellbeing order history
     *
     * @param  int $user_id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWellbeingOrdersAsync($user_id = null, string $contentType = self::contentTypes['getWellbeingOrders'][0])
    {
        return $this->getWellbeingOrdersAsyncWithHttpInfo($user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWellbeingOrdersAsyncWithHttpInfo
     *
     * Get wellbeing order history
     *
     * @param  int $user_id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWellbeingOrdersAsyncWithHttpInfo($user_id = null, string $contentType = self::contentTypes['getWellbeingOrders'][0])
    {
        $returnType = '\LifePlus\SDK\Model\WellbeingOrder[]';
        $request = $this->getWellbeingOrdersRequest($user_id, $contentType);
    ...
    /**
     * Create request for operation 'getWellbeingOrders'
     *
     * @param  int $user_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getWellbeingOrders'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWellbeingOrdersRequest($user_id = null, string $contentType = self::contentTypes['getWellbeingOrders'][0])
    {
