...
/**
 * HospitalsApi Class Doc Comment
 *
 * @category Class
 * @package  LifePlus\SDK
 * @author   OpenAPI Generator team
...
class HospitalsApi
{
    ...
    /**
     * Operation getHospitalDetails
     *
     * Get hospital details
     *
     * @param  int $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getHospitalDetails'] to see the possible values for this operation
     *
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LifePlus\SDK\Model\Hospital
     */
    public function getHospitalDetails($id, string $contentType = self::contentTypes['getHospitalDetails'][0])
    {
        list($response) = $this->getHospitalDetailsWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getHospitalDetailsWithHttpInfo
     *
     * Get hospital details
     *
     ...
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \LifePlus\SDK\Model\Hospital, HTTP status code, HTTP response headers (array of strings)
     */
    public function getHospitalDetailsWithHttpInfo($id, string $contentType = self::contentTypes['getHospitalDetails'][0])
    {
        $request = $this->getHospitalDetailsRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\LifePlus\SDK\Model\Hospital' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\LifePlus\SDK\Model\Hospital' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\LifePlus\SDK\Model\Hospital', []),
            ...
            $returnType = '\LifePlus\SDK\Model\Hospital';
    ...
    /**
     * Operation getHospitalDetailsAsync
     *
     * Get hospital details
     *
     * @param  int $id (required)
     ...
     */
    public function getHospitalDetailsAsync($id, string $contentType = self::contentTypes['getHospitalDetails'][0])
    {
        return $this->getHospitalDetailsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getHospitalDetailsAsyncWithHttpInfo
     *
     * Get hospital details
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getHospitalDetailsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getHospitalDetails'][0])
    {
        $returnType = '\LifePlus\SDK\Model\Hospital';
        $request = $this->getHospitalDetailsRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getHospitalDetails'
     *
     * @param  int $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getHospitalDetails'] to see the possible values for this operation
     *
     ...
     */
    public function getHospitalDetailsRequest($id, string $contentType = self::contentTypes['getHospitalDetails'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getHospitalDetails'
            );
        }


        $resourcePath = '/hospitals/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getHospitals'] to see the possible values for this operation
     *
     * @throws \LifePlus\SDK\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \LifePlus\SDK\Model\Hospital[]
     */
    public function getHospitals($type = null, string $contentType = self::contentTypes['getHospitals'][0])
    {
        list($response) = $this->getHospitalsWithHttpInfo($type, $contentType);
        return $response;
    }

    /**
     * Operation getHospitalsWithHttpInfo
     *
     * Get hospitals
     *
     ...
     * @return array of \LifePlus\SDK\Model\Hospital[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getHospitalsWithHttpInfo($type = null, string $contentType = self::contentTypes['getHospitals'][0])
    {
        $request = $this->getHospitalsRequest($type, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getHospitalsAsync($type = null, string $contentType = self::contentTypes['getHospitals'][0])
    {
        return $this->getHospitalsAsyncWithHttpInfo($type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getHospitalsAsyncWithHttpInfo
     *
     * Get hospitals
     *
     * @param  int $type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getHospitalsAsyncWithHttpInfo($type = null, string $contentType = self::contentTypes['getHospitals'][0])
    {
        $returnType = '\LifePlus\SDK\Model\Hospital[]';
        $request = $this->getHospitalsRequest($type, $contentType);
    ...
    /**
     * Create request for operation 'getHospitals'
     *
     * @param  int $type (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getHospitals'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getHospitalsRequest($type = null, string $contentType = self::contentTypes['getHospitals'][0])
    {



        $resourcePath = '/hospitals';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
